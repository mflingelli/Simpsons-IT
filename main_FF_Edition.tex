...
\begin{itemize}
  ...
  \item Für die Menge der komplexen Zahlen wird das Symbol $\mathbb {C}$ verwendet. 
\end{itemize}
\end{block}
}
...
\begin{itemize}
	...
	\item Mr. Burns möchte die Sicherheit des Verfahrens widerlegen. Seine Kryptoexperten schätzen, dies dauere 90.000 Jahre, falls sie auch die Wochenenden durcharbeiten
\end{itemize}
\end{block}
}
